...
@Component({
    ...
    templateUrl: 'components/bootflat-datepicker/bootflat-datepicker.html',
    styleUrls: ['components/bootflat-datepicker/bootflat-datepicker.css'],
...
export class BootFlatDatePicker implements OnInit, OnChanges {
    ...
    ngOnInit() {
        ...
        this.CalWidth = this.options.CalWidth !== undefined ? this.options.CalWidth : this.CalWidth;
